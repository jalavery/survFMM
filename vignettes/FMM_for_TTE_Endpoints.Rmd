...
another run it may have the largest treatment effect. To ensure comparable
estimates across multiple runs of the models, the `correct_label_switching`
function can be used. Currently, this function only supports k=2 subgroups; a
future enhancement of the package is to adapt it to align labels for >2
subgroups.
